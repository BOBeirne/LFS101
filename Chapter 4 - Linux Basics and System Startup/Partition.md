...
Example (partition numbers are just example, they depend on order of creation)

| Concept               | Windows                       | Linux                                |
| --------------------- | ----------------------------- | ------------------------------------ |
| Partition             | Disk1, Disk2                  | /dev/sda1, /dev/sdb1, swap           |
| [[File System]] types | NTFS, FAT32                   | ext4, XFS, Btrfs                     |
...
Default Linux HDD partition (sda) layout (numbers are just an example)
- / (sda1)
- home (sda2)
- var (sda3)
- swap (sda4)
