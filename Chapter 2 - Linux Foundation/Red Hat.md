...
- NOT a direct testing ground (too different) more like feature testing
- Large community of contributors
- Releases new version approx. every 6 months

### `CentOS` (RETIRED)

- also virtually identical to `RHEL` (free clone) 
- longer release cycle than Fedora
- Very popular in enterprise environments
- Stopped Updates in 2021 - Replaced by CentOS Stream
...
- Uses "Unbreakable Enterprise Kernel" (UEK) as an alternative kernel option